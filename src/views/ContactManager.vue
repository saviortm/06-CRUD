    ...
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          Eum necessitatibus, veritatis. Assumenda consectetur dolorum
          esse est molestias natus neque quaerat quo sint tempore! Expedita
          itaque maiores nisi provident quaerat tempore?</p>
        <form>
          <div class="row">
            <div class="col-md-6">
              <div class="row">
          ...
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="col-sm-1 d-flex flex-column justify-content-center align-items-center">
                <router-link :to="`/contacts/view/${contact.id}`" class="btn btn-warning m-1">
                  <i class="fa fa-eye"></i>
                </router-link>
                <router-link :to="`/contacts/edit/${contact.id}`" class="btn btn-primary m-1">
                  <i class="fa fa-pen"></i>
                </router-link>
                <button class="btn btn-danger m-1" @click="clickDeleteContact(contact.id)">
